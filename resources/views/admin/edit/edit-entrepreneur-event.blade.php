...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <form method="post" action="{{ route('admin.entrepreneur.update_event') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
                    @csrf
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="event_title" class="form-control" placeholder="Enter Event Name" value="{{$event_dtl->event_name}}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="date" id="date" class="form-control" value="{{date('Y-m-d',strtotime($event_dtl->date))}}">
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-sm-3 col-form-label">Edit Attachment (PDF)</label>
                            <div class="col-sm-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <textarea class="form-control" id="description" placeholder="Enter the Description"
                                    name="descrip">{!!$event_dtl->description!!}</textarea>
                            </div>
                        </div>
