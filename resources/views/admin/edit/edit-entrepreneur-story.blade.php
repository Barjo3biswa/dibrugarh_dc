...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <form method="post" action="{{ route('admin.entrepreneur.update_story') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
                    @csrf
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="event_title" class="form-control" placeholder="Enter Event Name" value="{{$event_dtl->name}}">
                            </div>
                        </div>
